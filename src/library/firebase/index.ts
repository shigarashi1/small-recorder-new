...
export type DocRefColumn<T extends TBaseDomainModel> = {
  fieldPath: keyof T | string;
  opStr: firebase.firestore.WhereFilterOp;
  ref: DocRef | string | number;
};
export type DocOrderColumn<T extends TBaseDomainModel> = {
  fieldPath: keyof T;
...
export type ModelConvFunc<T extends TBaseDomainModel> = (v: QueryDocSnapshot | DocData) => T;
...
// const toDomainModel = <T extends TBaseDomainModel>(v: QueryDocSnapshot): T =>
//   ({
//     id: v.id, //
